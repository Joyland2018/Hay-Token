...
J.Element = (function($){
    ...
    var initControlGroup = function(){
      ...
      $('#activityGroup').on('change',function(e,el,arg1,arg2){
        var type = el.data('type');
        if(type == 'request'){
            $('#request_list').css('display','block');
            $('#accept_list').css('display','none');
        }else if(type == 'accept'){
            $('#accept_list').css('display','block');
            $('#request_list').css('display','none');
        }
      });
